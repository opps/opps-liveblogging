...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'liveblogging_eventtype', (
            ...
            ('template_suffix', self.gf('django.db.models.fields.CharField')(max_length=35, null=True, blank=True)),
        ))
        db.send_create_signal(u'liveblogging', ['EventType'])

        # Adding field 'Event.event_type'
        db.add_column(u'liveblogging_event', 'event_type',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['liveblogging.EventType'], null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'liveblogging_event', 'event_type_id')
...
,
        ...
        u'liveblogging.eventtype': {
            ...
            'template_suffix': ('django.db.models.fields.CharField', [], {'max_length': '35', 'null': 'True', 'blank': 'True'}),
