...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'liveblogging_eventtype', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('title', self.gf('django.db.models.fields.CharField')(unique=True, max_length=30)),
            ('slug', self.gf('django.db.models.fields.SlugField')(max_length=35)),
            ('template_suffix', self.gf('django.db.models.fields.SlugField')(max_length=35, null=True, blank=True)),
        ))
        db.send_create_signal(u'liveblogging', ['EventType'])

        # Adding model 'Event'
        db.create_table(u'liveblogging_event', (
            ...
            ('event_type', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['liveblogging.EventType'], null=True, blank=True)),
        ))
        db.send_create_signal(u'liveblogging', ['Event'])

        # Adding model 'Message'
        db.create_table(u'liveblogging_message', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ...
            ('event', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['liveblogging.Event'])),
            ('message', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal(u'liveblogging', ['Message'])


    def backwards(self, orm):
        # Deleting model 'EventType'
        db.delete_table(u'liveblogging_eventtype')

        # Deleting model 'Event'
        db.delete_table(u'liveblogging_event')

        # Deleting model 'Message'
        db.delete_table(u'liveblogging_message')
    ...
    models = {
        ...
        u'liveblogging.event': {
            'Meta': {'ordering': "['-date_available', 'title', 'channel_long_slug']", 'object_name': 'Event', '_ormbases': [u'containers.Container']},
            u'container_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['containers.Container']", 'unique': 'True', 'primary_key': 'True'}),
            'event_type': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['liveblogging.EventType']", 'null': 'True', 'blank': 'True'})
        },
        u'liveblogging.eventtype': {
            'Meta': {'object_name': 'EventType'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'slug': ('django.db.models.fields.SlugField', [], {'max_length': '35'}),
            'template_suffix': ('django.db.models.fields.SlugField', [], {'max_length': '35', 'null': 'True', 'blank': 'True'}),
            'title': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '30'})
        },
        u'liveblogging.message': {
            'Meta': {'object_name': 'Message'},
            'date_available': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'null': 'True', 'db_index': 'True'}),
            'date_insert': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'date_update': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'event': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['liveblogging.Event']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
